...
| 動作 | 曝光度 | 時間 |
|---|---|---|
| **10–20 個**高質目錄提交 | **零**（填表,冇人回覆你） | 分幾星期 |
...
🚨 **落手之前先讀 [`docs/will-this-work.md`](docs/will-this-work.md)** —— 入面有下調過嘅老實評估同成功率。

| 時間 | 流量（已下調） | 收入 |
|---|---|---|
| Week 3 出街 | 爆發 300–2,000 | $3–20 |
| Week 5-8 | **跌返 50–250/月** ⚠️ | $3–15 |
| Month 5-6 | 400–1,500/月 | $25–95 |
| Month 7-12 | 800–3,000/月 | $50–190 |

**第 5-8 星期會覺得失敗咗。呢個係正常曲線** —— 爆發已散,SEO 未起。

**12 個月後真係做到 $100/月嘅機會,我估大約 10–15%。** 完整推算見 `will-this-work.md`。
