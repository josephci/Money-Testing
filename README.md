...
**唯一你需要跟嘅一份。** 兩條路點揀、第一日做咩、只有你做得到嘅 6 樣嘢。

**[`docs/how-passive-income-works.md`](docs/how-passive-income-works.md)** — 整場對話嘅總結：持續被動收入實際上點嚟、三個機制、你嘅最短路徑。
...
| 🚨 [`docs/auto-arbitrage.md`](docs/auto-arbitrage.md) | **套利全景** — 邊啲仲 work、要幾多本金先交到月費、套利利潤嘅三個來源、⭐ 迎新優惠（唯一低本金又數學保證嗰個）、五個偽套利陷阱 |
